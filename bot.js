...
client.on('message', msg => {
  ...
  if (msg.author.id === userID){
    ...
    if (msg.content === 'HI') {
    msg.channel.send({files: ["https://i.imgur.com/pnKZdsa.png"]});};
  ...
  if (msg.content === '響子~') {
    msg.reply('你看今天做的,是裝滿愛情的菜單♪,是準備給,我最喜歡的泓錡<:kyokoLabu:626047724755615745>',{files: ["https://i.imgur.com/bBMtB3E.jpg"]});}
  
  if (msg.content === '響子我要洗澡了') {
    msg.channel.send({files: ["https://i.imgur.com/qrKCDCj.jpg"]},);}
  
  if (msg.content === '番號') {
    msg.reply('都已經有我了..為甚麼還要找那種東西呢..',{files: ["https://i.imgur.com/3w3YDKn.png"]});}
  
  if (msg.content === '響子') {
    msg.channel.send('最喜歡的人...哼哼...當然..就是你呀..泓錡♪',{files: ["https://i.imgur.com/ihukR0L.png"]});}
  ...
  if (msg.content === '響子!') {
    ...
    msg.channel.send(facts[fact],{file: picture[Math.floor(Math.random() * picture.length)]});}
  	...
  	if (msg.content === '好!我發誓') {
		msg.channel.send('嗯!泓錡謝謝你♪我會一直陪在你身邊的♪',{files: ["https://i.imgur.com/tuK1gfp.png"]});}

	if (msg.content === '響子~~') {
		msg.channel.send('雖然平常沒什麼在做甜點…不過這次努力做了喔♪',{files: ["https://imas.gamedbs.jp/cg/image_sp/card/l_noframe/e9840742d5600f0b4eeb44094231e27b.jpg"]});}
  ...
  if (msg.author.id != userID) {
	...
	if (msg.content === '響子~') {
    msg.reply('可以不要擅自叫別人的名字嗎...',{files: ["https://i.imgur.com/EecOzBD.png"]});}
	
	if (msg.content === '響子我要洗澡了') {
    msg.reply('關我甚麼事...<:blackwa:585370278360776704>',);}
	
	if (msg.content === '響子') {
    msg.channel.send('泓...欸...怎麼是你啊..QQ...',{files: ["https://i.imgur.com/EecOzBD.png"]});}
	
	if (msg.content === '響子!') {
    msg.channel.send('泓...欸...怎麼是你啊..沒有事情的話就請不要叫我好嗎?',{files: ["https://i.imgur.com/EecOzBD.png"]});}
	
	if (msg.content === '響子>_<') {
    msg.channel.send('痾...'+msg.author.toString()+'你以為加那個不知所謂的表情我就會回你甚麼嗎...如果你是泓錡的朋友我是可以勉強回你一下下...',{files: ["https://i.imgur.com/EecOzBD.png"]});}
...
case '我要一份卯月色圖!': 
if (msg.author.id === userID) {
	msg.channel.send({files: ["https://imas.gamedbs.jp/cg/image_sp/card/l_noframe/e1e37fcbbe67e706cb0bb336f9d972c5.jpg"]})
...
case '響子你好可愛':
msg.channel.send({files: ["https://i.imgur.com/VBWsdrw.png"]});
break;
...
.then(() => msg.channel.send({files: ["https://i.imgur.com/n5Av1xz.png"]}));
break;

case '皮喵太':
msg.channel.send({files: ["https://i.imgur.com/7aaGoCW.gif"]})
.then(() => msg.channel.send({files: ["https://i.imgur.com/EXqaquX.png"]}));
break;
...
client.on('message', (receivedMessage) => {
    ...
    if (receivedMessage.content.includes(client.user.toString())) {
        ...
        receivedMessage.channel.send(receivedMessage.author.toString()+"你是要先洗澡呢？要先吃飯呢？還是要先吃·我·呢？ ",{files: ["https://i.imgur.com/wWXFv3B.jpg"]})
    }
	}
})
